...
pattern = r'<CardContent className="p-6 pt-5 flex-1 flex flex-col relative z-10">\s*\{batches\.length > 0 \? \(\s*<div className="rounded-xl bg-slate-100/35 text-foreground flex flex-col min-h-0 flex-1 overflow-hidden dark:bg-black/20 dark:border dark:border-white/\[0\.05\]">\s*<div className="flex items-center justify-between border-b border-slate-200/50 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 px-4 py-2\.5">.*?<div className="relative flex-1 min-h-0">'
