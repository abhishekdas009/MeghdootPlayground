...
old_str = '''<div className="flex flex-1 items-start justify-between gap-4">
                        <div>
...
new_str = '''<div className="flex flex-1 items-start justify-between gap-4">
                        <div>
                          <div className="flex items-center gap-2 flex-wrap">
                        <CardTitle className="text-xl md:text-2xl font-black tracking-tight leading-tight text-foreground">Paste Failed<br/>Results</CardTitle>
                        </div>
