...
# Wait, searchError might just be a standard error like "Model Number is required."
# We should probably only show the illustration if the error is "No matching warranty term found." or similar empty state.
# But "searchError" string is set to that in the API route. Let's just wrap it nicely.
