...
old_bg = """    <div className="app-shell relative min-h-screen overflow-x-hidden bg-slate-50 dark:bg-[#070707]">
...
new_bg = """    <div className="app-shell relative min-h-screen overflow-x-hidden bg-slate-50 dark:bg-[url('/images/dark-bg.png')] dark:bg-cover dark:bg-center dark:bg-fixed dark:bg-no-repeat">
