...
export function Sidebar() {
  ...
  const renderNavItems = (onNavigate?: () => void) =>
    NAV_ITEMS.map((item) => {
      ...
      const iconBg =
        NAV_ICON_BG[item.href] ?? "bg-gray-500/10 text-gray-600 dark:text-gray-400";
  ...
  // Footer section that houses Theme Toggle, User Avatar, and System Status (since removed from top bar)
